...
import '../../../data/dataSources/remoteDataSource/profile_remote_dto_impl.dart'
    as _i56;
import '../../../data/repo/exam_repo_impl.dart' as _i177;
...
import '../../../domain/repo/exam_repo.dart' as _i171;
...
import '../../../domain/useCases/check_answers_usecase.dart' as _i709;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i1025.ExamRepoDS>(
        () => _i667.ExamRepoDsImpl(gh<_i901.ApiManager>()));
    ...
    gh.factory<_i171.ExamRepo>(
        () => _i177.ExamRepoImpl(examRepoDS: gh<_i1025.ExamRepoDS>()));
    ...
    gh.factory<_i709.CheckAnswersUsecase>(
        () => _i709.CheckAnswersUsecase(gh<_i171.ExamRepo>()));
    gh.factory<_i36.GetAllQuestionsOnExamUseCase>(
        () => _i36.GetAllQuestionsOnExamUseCase(gh<_i171.ExamRepo>()));
    gh.factory<_i724.ExamCubit>(() => _i724.ExamCubit(
          gh<_i709.CheckAnswersUsecase>(),
          gh<_i36.GetAllQuestionsOnExamUseCase>(),
        ));
